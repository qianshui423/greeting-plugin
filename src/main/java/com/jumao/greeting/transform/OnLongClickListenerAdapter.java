...
public class OnLongClickListenerAdapter extends AdviceAdapter {

    private String className;

    public OnLongClickListenerAdapter(MethodVisitor mv, int access, String name, String desc, String className) {
